defimpl ForgeSdk.Display, for: ForgeAbi.StateContext do
  ...
  def display(data, true) do
    ...
    Map.merge(basic, %{
      ...
      genesis_tx: Display.display(Rpc.get_tx(RequestGetTx.new(hash: basic.genesis_tx))),
      renaissance_tx: Display.display(Rpc.get_tx(RequestGetTx.new(hash: basic.renaissance_tx)))
    })
  end
end
