defmodule ForgeSdk.Util.Varint do
  @moduledoc """
  ...
  iex> ForgeSdk.Util.Varint.encode_varint(127)
  "\d"

  iex> "\d" === <<127>>
  true

  iex> ForgeSdk.Util.Varint.encode_varint(128)
  <<128, 1>>

  iex> ForgeSdk.Util.Varint.encode_varint(1000)
  <<232, 7>>
  """
  ...
  iex> ForgeSdk.Util.Varint.encode_zigzag(1)
  <<2>>

  iex> ForgeSdk.Util.Varint.encode_zigzag(-1)
  <<1>>

  iex> ForgeSdk.Util.Varint.encode_zigzag(128)
  <<128, 2>>
  ...
  iex> ForgeSdk.Util.Varint.decode_varint(<<127>>)
  {127, ""}

  iex> ForgeSdk.Util.Varint.decode_varint(<<128, 1>>)
  {128, ""}

  iex> ForgeSdk.Util.Varint.decode_varint(<<232, 7>>)
  {1000, ""}

  iex> ForgeSdk.Util.Varint.decode_varint(<<128>>)
  :none
  """
  ...
  iex> ForgeSdk.Util.Varint.decode_zigzag(<<2>>)
  {1, ""}

  iex> ForgeSdk.Util.Varint.decode_zigzag(<<1>>)
  {-1, ""}

  iex> ForgeSdk.Util.Varint.decode_zigzag(<<128, 2>>)
  {128, ""}

  iex> ForgeSdk.Util.Varint.decode_zigzag(<<255, 1>>)
  {-128, ""}
  """
